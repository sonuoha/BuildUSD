...
def _apply_federation(
    ...
    *,
    ...
    for master_stage_path, group in grouped.items():
        ...
        federation_origin = first_plan.shared_site_base_point
        ...
        for task in group[1:]:
            if task.plan.shared_site_base_point != federation_origin:
                LOG.warning(
                    "Federation origin differs for %s; using the first plan's shared site base point.",
